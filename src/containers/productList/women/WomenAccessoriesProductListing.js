...
const WomenAccessoriesProductListing = () => {
            ...
            <div className="list-of-category">
                ...
                >
                    ...
                    <div
                        ...
                        onMouseLeave={() => handleMouseRemoveWomen(false)}
                    >
                        <Link onClick={() => { dispatch(setProducts([])) }} to="/women/shoes" className="hover-color categories-name-in-list-shoes">Shoes</Link>
                        <Link onClick={() => { handleReloadPage() }} to="/women/accessories" className="hover-color categories-name-in-list-accessories">Accessories</Link>
                    </div>
                </div>
            </div>
...
export default WomenAccessoriesProductListing