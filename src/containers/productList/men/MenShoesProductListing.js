...
const options = {
    ...
    /* headers: {
        ...
        'X-RapidAPI-Host': 'asos2.p.rapidapi.com'
    } this is new but not subscribed yet */
    headers: {
        'X-RapidAPI-Key': '5ed9798687msh2cf05279777059ep17d229jsnff46a1571156',
        'X-RapidAPI-Host': 'asos2.p.rapidapi.com'
    }
            ...
            <div className="list-of-category">
                ...
                >
                    ...
                    <div
                        ...
                        onMouseLeave={() => handleMouseRemove(false)}
                    >
                        <Link onClick={() => { handleReloadPage() }} to="/men/shoes" className="hover-color categories-name-in-list-shoes">Shoes</Link>
...
export default MenShoesProductListing